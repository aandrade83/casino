...
var core_url = 'https://play.casinogamesonline.com/utilities/games/blackjack_europe/action.php?gid='+gid+'&';
...
function preload (){
	...
	//Load elements
	//Background
	this.load.image('background', 'utilities/games/blackjack_europe/imgs/back.jpg');
	//chips
	...
	//Others
	this.load.image('arrow', 'utilities/games/blackjack_europe/imgs/green_arrow.png');
	//sounds
	this.load.audio('card_flip_fx', 'utilities/games/blackjack_europe/sounds/cardflip.wav');
