...
function preload (){
	...
	//Load elements
	//Images
	this.load.image('background', '/utilities/games/multi_slot_viking/imgs/back.png?v2');
	this.load.image('pay_table', '/utilities/games/multi_slot_viking/imgs/pay_table.png?v=7');
	this.load.image('info', '/utilities/games/multi_slot_viking/imgs/info.png');
	this.load.image('main_btn', '/utilities/games/multi_slot_viking/imgs/bet_btn.png?v=3');
	this.load.image('giant', '/utilities/games/multi_slot_viking/imgs/giant.png');
	this.load.image('area', '/utilities/games/multi_slot_viking/imgs/blank_area.png');
	//this.load.image('area', '/utilities/games/multi_slot_viking/imgs/area.jpg');
	
	
	this.load.image('reel_back', '/utilities/games/multi_slot_crypto/imgs/reel_back.png');
	this.load.image('reel1', '/utilities/games/multi_slot_viking/imgs/reel1.png?v1');
	this.load.image('reel2', '/utilities/games/multi_slot_viking/imgs/reel2.png?v1');
	this.load.image('reel3', '/utilities/games/multi_slot_viking/imgs/reel3.png?v1');
	this.load.image('reel4', '/utilities/games/multi_slot_viking/imgs/reel4.png?v1');
	this.load.image('reel5', '/utilities/games/multi_slot_viking/imgs/reel5.png?v1');
	
	for(var i=1; i<= 10; i++){
		this.load.image('figure'+i, '/utilities/games/multi_slot_viking/imgs/figures/fig'+i+'.png?v=2?v=4'); 
	}
	
	for(var i=1; i<= 10; i++){
		this.load.image('figure_on'+i, '/utilities/games/multi_slot_viking/imgs/figures_on/fig'+i+'.png?v=4'); 
	}
	
	//Animations
	for(var i=1; i<=62; i++){
		this.load.image('animation_'+i, '/utilities/games/multi_slot_viking/imgs/animation/'+i+'.png');
	}
		
	
	//Sounds
	this.load.audio('pin', '/utilities/games/multi_slot_viking/sounds/pin.wav?v=2');
	this.load.audio('spin', '/utilities/games/multi_slot_viking/sounds/spin_sound.wav?v=3');
	this.load.audio('win1', '/utilities/games/multi_slot_viking/sounds/win1.wav?v=2');
	this.load.audio('win2', '/utilities/games/multi_slot_viking/sounds/win2.wav?v=2');
	this.load.audio('big_win', '/utilities/games/multi_slot_viking/sounds/big_win.mp3?v=2');
	this.load.audio('music', '/utilities/games/multi_slot_viking/sounds/music.mp3?v=2');
	this.load.audio('scream', '/utilities/games/multi_slot_viking/sounds/scream.wav?v=2');
...
function create (){
	...
	main_btn.displayWidth=game.config.width*0.15; 
	...
	//btns
	var cvalue_plus = this.add.image(game_width/1.02, game_height/3.13, 'area').setInteractive();
	...
	var cvalue_minus = this.add.image(game_width/1.1, game_height/3.13, 'area').setInteractive();
	...
	var lines_plus = this.add.image(game_width/1.02, game_height/1.47, 'area').setInteractive();
	...
	var lines_minus = this.add.image(game_width/1.1, game_height/1.47, 'area').setInteractive();
	...
	spin_btn.displayWidth=game.config.width*0.08; 
	spin_btn.displayHeight=game.config.width*0.08; 
	spin_btn.alpha = 0.5;
	...
	var machine_text_small = { font: (game_width*0.015) + "px Arial", fill: "#000000", align: "center" };
	
	//set texts positions
	bet_amount_text = this.add.text(game_width/1.06, game_height/3.21, current_bet, machine_text_small);
	bet_amount_text.setOrigin(0.5);
	lines_amount_text = this.add.text(game_width/1.06, game_height/1.47, 25, machine_text_small);
	...
	info_btn = this.add.image(game_width/1.06, game_height/6.43, 'info').setInteractive();
	info_btn.displayWidth=game.config.width*0.03; 
...
function update (){
	...
	for(var i = 0; i < vibrating_figures.length; i++){ 
		if(vibrating_figures_direction[vibrating_figures[i]] == "off"){
			figures_on[vibrating_figures[i]].alpha -= 0.02;
		}else{
			figures_on[vibrating_figures[i]].alpha += 0.02;
		}
