...
<body>
	...
	if($_company ->vars["prov_fair"]){
		$server_num = generate_server_seed("bcrt",0,100000000);
    ...
    <div id="btn_box" class="btn_box">
    	<input type="button" id="btn_clear" value="Clear" onClick="avoid_doubleclick(this.id); clear_table('player');" class="btn red game_btn after_game_btc" />
        <input type="button" id="btn_spin" value="Deal" onClick="avoid_doubleclick(this.id); deal();" class="btn green game_btn" />
        <input type="button" id="btn_rebet" value="Rebet" onClick="avoid_doubleclick(this.id); rebet(false);" class="btn blue game_btn after_game_btc" />
        <input type="button" id="btn_rebet_spin" value="Rebet & Deal" onClick="avoid_doubleclick(this.id); rebet(true);" class="btn purple game_btn after_game_btc" />
    </div>
	<div id="spacer"></div>
</body>
</html>
