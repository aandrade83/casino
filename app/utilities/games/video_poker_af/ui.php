...
<body>
	...
	if($_company ->vars["prov_fair"]){
		$server_num = generate_server_seed("vdpkraf",0,100000000);
    ...
    <div id="hand_plus" class="btn_small handplus" onClick="change_hand('+');"></div>
    <div id="hand_min" class="btn_small handmin" onClick="change_hand('-');"></div>
	<div id="spacer"></div>
</body>
</html>