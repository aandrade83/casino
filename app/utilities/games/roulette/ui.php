...
<body>
	...
	if($_company ->vars["prov_fair"]){
		$server_num = generate_server_seed("rlt",0,37);
		$player_num = mt_rand(0,37);
    ...
    <div id="btn_box" class="btn_box">
    	<input type="button" id="btn_clear" value="Clear" onClick="avoid_doubleclick(this.id); clear_table('player'); place_bets_sound.play();" class="btn red game_btn" />
        <input type="button" id="btn_spin" value="Spin" onClick="avoid_doubleclick(this.id); spin();" class="btn green game_btn" />
        <input type="button" id="btn_rebet" value="Rebet" onClick="avoid_doubleclick(this.id); rebet(false);  place_bets_sound.play();" class="btn blue game_btn" />
        <input type="button" id="btn_rebet_spin" value="Rebet & Spin" onClick="avoid_doubleclick(this.id); rebet(true);" class="btn purple game_btn" />
    </div>
	<div id="spacer"></div>
</body>
</html>
