...
class roulette{
	...
	function __construct($id_player) {
		...
		$this->bet_areas["00"] = array("numbers"=>array('00'), "odds"=>35);
		$this->bet_areas["0-00"] = array("numbers"=>array('00',0), "odds"=>17);
		$this->bet_areas["0-00-2"] = array("numbers"=>array('00',0,2), "odds"=>11);
		...
		$this->bet_areas["0-1-2-3-00"] = array("numbers"=>array(0,1,2,3,'00'), "odds"=>6);
		...
		$this->bet_areas["00-3"] = array("numbers"=>array('00',3), "odds"=>17);
		...
		$this->bet_areas["2-00-3"] = array("numbers"=>array(2,'00',3), "odds"=>11);
	...
	function spin($bets, $pf_result = "na"){
		...
		if(is_numeric($pf_result)){
			...
			if($winning_number > 37){$winning_number -= 38;}
			$winning_number = intval($winning_number);
		}else{
			//Random
			$winning_number = rc_random(0,37);
		}
		
		if($winning_number == 37){$winning_number = '00';}
