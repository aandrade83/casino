...
function create (){
	...
	bet_areas_data.push({id: "0", xpos: game_width/6.9, ypos: game_height/2.05, w: game.config.width*0.05, h:game.config.width*0.050, divider:8});
	bet_areas_data.push({id: "00", xpos: game_width/6.3, ypos: game_height/3.35, w: game.config.width*0.05, h:game.config.width*0.050, divider:8});
	bet_areas_data.push({id: "0-00", xpos: game_width/7.5, ypos: game_height/2.55, w: game.config.width*0.02, h:game.config.width*0.02, divider:4});
	bet_areas_data.push({id: "0-00-2", xpos: game_width/6.5, ypos: game_height/2.55, w: game.config.width*0.02, h:game.config.width*0.02, divider:2.66});
	...
	bet_areas_data.push({id: "0-1-2-3-00", xpos: game_width/5.9, ypos: game_height/1.9, w: game.config.width*0.02, h:game.config.width*0.02, divider:1.33});
	...
	bet_areas_data.push({id: "00-3", xpos: game_width/5.52, ypos: game_height/3.47, w: game.config.width*0.02, h:game.config.width*0.025, divider:4});
	...
	bet_areas_data.push({id: "2-00-3", xpos: game_width/5.62, ypos: game_height/2.95, w: game.config.width*0.02, h:game.config.width*0.02, divider:2.66});
	...
	//number angles
	bucket_radius = numeric_wheel.displayWidth*0.38;
	numbers_angles[0] = (0);
	numbers_angles[28] = (9);
	numbers_angles[9] = (18);
	numbers_angles[26] = (28);
	numbers_angles[30] = (37);
	numbers_angles[11] = (47);
	numbers_angles[7] = (56);
	numbers_angles[20] = (66);
	numbers_angles[32] = (75);
	numbers_angles[17] = (85);
	numbers_angles[5] = (94);
	numbers_angles[22] = (104);
	numbers_angles[34] = (113);
	numbers_angles[15] = (123);
	numbers_angles[3] = (132);
	numbers_angles[24] = (142);
	numbers_angles[36] = (151);
	numbers_angles[13] = (161);
	numbers_angles[1] = (170);
	numbers_angles['00'] = (180);
	numbers_angles[27] = (189);
	numbers_angles[10] = (199);
	numbers_angles[25] = (208);
	numbers_angles[29] = (218);
	numbers_angles[12] = (227);
	numbers_angles[8] = (237);
	numbers_angles[19] = (246);
	numbers_angles[31] = (256);
	numbers_angles[18] = (265);
	numbers_angles[6] = (275);
	numbers_angles[21] = (284);
	numbers_angles[33] = (294);
	numbers_angles[16] = (303);
	numbers_angles[4] = (313);
	numbers_angles[23] = (322);
	numbers_angles[35] = (332);
	numbers_angles[14] = (341);
	numbers_angles[2] = (351);
