...
<body>
	...
	if($_company ->vars["prov_fair"]){
		$server_num = generate_server_seed("chdpkr",0,100000000);
    ...
    <div id="btn_box" class="btn_box">
    	<input type="button" id="btn_call" value="Call" onClick="avoid_doubleclick(this.id); call();" class="btn blue game_btn" />
        <input type="button" id="btn_fold" value="Fold" onClick="avoid_doubleclick(this.id); fold();" class="btn red game_btn" />
        
        <input type="button" id="btn_bet" value="Bet" onClick="avoid_doubleclick(this.id); next_move(1);" class="btn blue game_btn" />
        <input type="button" id="btn_check" value="Check" onClick="avoid_doubleclick(this.id); next_move(0);" class="btn red game_btn" />
