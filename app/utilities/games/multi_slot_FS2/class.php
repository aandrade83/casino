...
class multi_slot{
	...
	function __construct($id_player) {
		 ...
		 $this->figures_on_reels[1] = array(
								  ...
								  array("figure"=>"fig8","amount"=>"24"),
								  array("figure"=>"fig9","amount"=>"21"),
								  array("figure"=>"fig10","amount"=>"27"),
	...
	function get_prize($bet_amount, $line_position ,$reels_result){
		...
		if($reels_result[$line[0]-1] == $reels_result[$line[1]-1] && $reels_result[$line[1]-1] == $reels_result[$line[2]-1] && $reels_result[$line[2]-1] == $reels_result[$line[3]-1] && $reels_result[$line[3]-1] == $reels_result[$line[4]-1]){			
			...
			switch($reels_result[$line[0]-1]){ 
				...
				case "fig3": $win = $bet_amount * 1250;  break;
				case "fig4": $win = $bet_amount * 800;  break;
				case "fig5": $win = $bet_amount * 600;  break;
				case "fig6": $win = $bet_amount * 450;  break;
				case "fig7": $win = $bet_amount * 350;  break;
				case "fig8": $win = $bet_amount * 250;  break;
				case "fig9": $win = $bet_amount * 200;  break;
				case "fig10": $win = $bet_amount * 150;  break;
				case "fig11": $win = $bet_amount * 100; break;
				case "fig12": $win = $bet_amount * 75; $fsp = 1;  break;
				case "fig13": $win = $bet_amount * 50; $fsp = 5;  break;   
			}
			...
			switch($reels_result[$line[0]-1]){ 
				...
				case "fig2": $win = $bet_amount * 1000;  break;
				case "fig3": $win = $bet_amount * 750;  break;
				case "fig4": $win = $bet_amount * 500;  break;
				case "fig5": $win = $bet_amount * 400;  break;
				case "fig6": $win = $bet_amount * 300;  break;
				case "fig7": $win = $bet_amount * 250;  break;
				case "fig8": $win = $bet_amount * 200;  break;
				case "fig9": $win = $bet_amount * 125;  break;
				case "fig10": $win = $bet_amount * 100;  break;
				case "fig11": $win = $bet_amount * 75;  break;
				case "fig12": $win = $bet_amount * 45; $fsp = 0; break;
				case "fig13": $win = $bet_amount * 25; $fsp = 2;  break;
			}
			...
			switch($reels_result[$line[0]-1]){ 
				...
				case "fig3": $win = $bet_amount * 500;  break;
				...
				case "fig11": $win = $bet_amount * 25;  break;
				case "fig12": $win = $bet_amount * 10; $fsp = 0; break;
				case "fig13": $win = $bet_amount * 5; $fsp = 0; break; 
			}
	...
	function generate_reel_result($reel_content){
		...
		$fig1 = $reel_content[mt_rand(0,189)];
		$fig2 = $fig1;
		while($fig2 == $fig1){
			$fig2 = $reel_content[mt_rand(0,189)];
		}
		$fig3 = $fig1;
		while($fig3 == $fig1 || $fig3 == $fig2){
			$fig3 = $reel_content[mt_rand(0,189)];
		}
	...
	function set_reels_content($fixed = true){ 
		...
		if($fixed){
			...
			$json = file_get_contents($_SERVER['DOCUMENT_ROOT']."/utilities/games/multi_slot_FS2/json/pirates.txt?v=2");		
