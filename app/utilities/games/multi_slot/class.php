...
class multi_slot{
	...
	function __construct($id_player) {
		 ...
		 /*$this->figures_on_reels[1] = array(
								  array("figure"=>"tuta","amount"=>"3"),
								  array("figure"=>"cross","amount"=>"4"),
								  array("figure"=>"beetle","amount"=>"7"),
								  array("figure"=>"eye","amount"=>"8"),
								  array("figure"=>"pyramid","amount"=>"8"),
								  array("figure"=>"vessel","amount"=>"8"),
								  array("figure"=>"J","amount"=>"16"),
								  array("figure"=>"Q","amount"=>"14"),
								  array("figure"=>"K","amount"=>"12"),
								  array("figure"=>"A","amount"=>"15")
							 );
		 
		 $this->figures_on_reels[2] = array(
								  array("figure"=>"tuta","amount"=>"1"),
								  array("figure"=>"cross","amount"=>"3"),
								  array("figure"=>"beetle","amount"=>"5"),
								  array("figure"=>"eye","amount"=>"8"),
								  array("figure"=>"pyramid","amount"=>"10"),
								  array("figure"=>"vessel","amount"=>"10"),
								  array("figure"=>"J","amount"=>"22"),
								  array("figure"=>"Q","amount"=>"19"),
								  array("figure"=>"K","amount"=>"17"),
								  array("figure"=>"A","amount"=>"15")
							 );
		 ...
		 $this->figures_on_reels[3] = array(
								  array("figure"=>"tuta","amount"=>"3"),
								  array("figure"=>"cross","amount"=>"3"),
								  array("figure"=>"beetle","amount"=>"10"),
								  array("figure"=>"eye","amount"=>"10"),
								  array("figure"=>"pyramid","amount"=>"10"),
								  array("figure"=>"vessel","amount"=>"8"),
								  array("figure"=>"J","amount"=>"21"),
								  array("figure"=>"Q","amount"=>"19"),
								  array("figure"=>"K","amount"=>"14"),
								  array("figure"=>"A","amount"=>"12")
							 );
		 
		 
		 $this->figures_on_reels[4] = array(
								  array("figure"=>"tuta","amount"=>"2"),
								  array("figure"=>"cross","amount"=>"4"),
								  array("figure"=>"beetle","amount"=>"7"),
								  array("figure"=>"eye","amount"=>"7"),
								  array("figure"=>"pyramid","amount"=>"7"),
								  array("figure"=>"vessel","amount"=>"8"),
								  array("figure"=>"J","amount"=>"25"),
								  array("figure"=>"Q","amount"=>"19"),
								  array("figure"=>"K","amount"=>"17"),
								  array("figure"=>"A","amount"=>"15")
							 );
		 ...
		 $this->figures_on_reels[1] = array(
								  array("figure"=>"tuta","amount"=>"5"),
								  array("figure"=>"cross","amount"=>"6"),
								  array("figure"=>"beetle","amount"=>"9"),
								  array("figure"=>"eye","amount"=>"10"),
								  array("figure"=>"pyramid","amount"=>"10"),
								  array("figure"=>"vessel","amount"=>"10"),
								  array("figure"=>"J","amount"=>"15"),
								  array("figure"=>"Q","amount"=>"15"),
								  array("figure"=>"K","amount"=>"15"),
								  array("figure"=>"A","amount"=>"15")
							 );
		 
		 $this->figures_on_reels[2] = array(
								  array("figure"=>"tuta","amount"=>"3"),
								  array("figure"=>"cross","amount"=>"5"),
								  array("figure"=>"beetle","amount"=>"7"),
								  array("figure"=>"eye","amount"=>"10"),
								  array("figure"=>"pyramid","amount"=>"12"),
								  array("figure"=>"vessel","amount"=>"12"),
								  array("figure"=>"J","amount"=>"16"),
								  array("figure"=>"Q","amount"=>"15"),
								  array("figure"=>"K","amount"=>"15"),
								  array("figure"=>"A","amount"=>"15")
		 ...
		 $this->figures_on_reels[3] = array(
								  array("figure"=>"tuta","amount"=>"3"),
								  array("figure"=>"cross","amount"=>"3"),
								  array("figure"=>"beetle","amount"=>"12"),
								  array("figure"=>"eye","amount"=>"12"),
								  array("figure"=>"pyramid","amount"=>"12"),
								  array("figure"=>"vessel","amount"=>"10"),
								  array("figure"=>"J","amount"=>"17"),
								  array("figure"=>"Q","amount"=>"17"),
								  array("figure"=>"K","amount"=>"12"),
								  array("figure"=>"A","amount"=>"12")
							 );
		 ...
		 $this->figures_on_reels[4] = array(
								  ...
								  array("figure"=>"cross","amount"=>"6"),
								  array("figure"=>"beetle","amount"=>"9"),
								  array("figure"=>"eye","amount"=>"9"),
								  array("figure"=>"pyramid","amount"=>"9"),
								  array("figure"=>"vessel","amount"=>"8"),
								  array("figure"=>"J","amount"=>"17"),
								  array("figure"=>"Q","amount"=>"17"),
								  array("figure"=>"K","amount"=>"15"),
	...
	function get_prize($bet_amount, $line_position ,$reels_result){
		...
		if($reels_result[$line[0]-1] == $reels_result[$line[1]-1] && $reels_result[$line[1]-1] == $reels_result[$line[2]-1] && $reels_result[$line[2]-1] == $reels_result[$line[3]-1] && $reels_result[$line[3]-1] == $reels_result[$line[4]-1]){			
			...
			switch($reels_result[$line[0]-1]){ 
				case "tuta": $win = $bet_amount * 5000;  break;
				case "cross": $win = $bet_amount * 1000;  break;
				case "beetle": $win = $bet_amount * 750;  break;
				case "eye": $win = $bet_amount * 750;  break;
				case "pyramid": $win = $bet_amount * 500;  break;
				case "vessel": $win = $bet_amount * 500;  break;
				case "A": $win = $bet_amount * 250;  break;
				case "K": $win = $bet_amount * 250;  break;
				case "Q": $win = $bet_amount * 150;  break;
				case "J": $win = $bet_amount * 150;  break;
			}
			...
			//X4
			switch($reels_result[$line[0]-1]){ 
				case "tuta": $win = $bet_amount * 1000;  break;
				case "cross": $win = $bet_amount * 500;  break;
				case "beetle": $win = $bet_amount * 350;  break;
				case "eye": $win = $bet_amount * 350;  break;
				case "pyramid": $win = $bet_amount * 250;  break;
				case "vessel": $win = $bet_amount * 250;  break;
				case "A": $win = $bet_amount * 200;  break;
				case "K": $win = $bet_amount * 200;  break;
				case "Q": $win = $bet_amount * 100;  break;
				case "J": $win = $bet_amount * 100;  break;
			}
			...
			//X3
			switch($reels_result[$line[0]-1]){ 
				case "tuta": $win = $bet_amount * 500;  break;
				case "cross": $win = $bet_amount * 250;  break;
				case "beetle": $win = $bet_amount * 100;  break;
				case "eye": $win = $bet_amount * 100;  break;
				case "pyramid": $win = $bet_amount * 75;  break;
				case "vessel": $win = $bet_amount * 75;  break;
				case "A": $win = $bet_amount * 50;  break;
				case "K": $win = $bet_amount * 50;  break;
				case "Q": $win = $bet_amount * 25;  break;
				case "J": $win = $bet_amount * 25;  break; 
			}
	...
	function set_reels_content($fixed = true){
		...
		if($fixed){
			...
			$json = file_get_contents($_SERVER['DOCUMENT_ROOT']."/utilities/games/multi_slot/json/egypt.txt");	
