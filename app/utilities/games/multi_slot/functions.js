...
function create (){
	...
	reels[1] = this.add.image(game_width/3.70, (game_height/-50)*52.5, 'reel2');
	reels[1].displayWidth=game.config.width*0.12; 
	reels[1].scaleY=reels[1].scaleX;
	reels[1].alpha = 0;
	
	reels[2] = this.add.image(game_width/2.26, (game_height/-50)*52.5, 'reel3');
	...
	var fi = 0;
	var fignames = new Array("beetle","cross","eye","pyramid","tuta","vessel","J","Q","K","A");
	...
	//set text settings
	line_text_style = { font: (game_width*0.018) + "px Arial", fill: "#2aff00", align: "left" };
	...
	//set text settings
	machine_text_style = { font: (game_width*0.018) + "px Arial", fill: "#2aff00", align: "center" };
	...
	balance_amount_text = this.add.text(game_width/1.105, game_height/4, current_balance, machine_text_style);
	total_amount_text = this.add.text(game_width/1.105, game_height/2.25, current_bet * max_lines, machine_text_style);
	win_amount_text = this.add.text(game_width/1.105, game_height/1.59, "0", machine_text_style);
