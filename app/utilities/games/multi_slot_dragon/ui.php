...
<body>
    ...
    <div class="game_btns_box">
        ...
        <div class="sub_btn_box">
            ...
            <input name="" id="spin_btn" type="image" class="btn_big" onClick="spin();" src="utilities/games/multi_slot_FS2/imgs/spin_on.png">
            <input name="" id="betmax_btn" type="image" class="btn_big" onClick="change_lines(true); spin();" src="utilities/games/multi_slot_FS2/imgs/betmax_on.png">
