//Set game vars
var core_url = "/utilities/games/classic_slot/action.php?gid=" + gid + "&";
...
function preload() {
  ...
  this.load.image(
    "background",
    "utilities/games/classic_slot/imgs/back.png?v4",
  );
  ...
  this.load.image(
    "reel_back",
    "utilities/games/classic_slot/imgs/reel_back.jpg?v2",
  );
  //Sounds
  this.load.audio(
    "spin_sound",
    "utilities/games/classic_slot/sounds/Slot_Spin.mp3",
  );
  this.load.audio(
    "winning_sound",
    "utilities/games/classic_slot/sounds/winning.mp3",
  );
  this.load.audio(
    "background_sound",
    "utilities/games/classic_slot/sounds/sound_back.mp3",
  );
}
...
function create() {
  ...
  //back sound
  back_sound = this.sound.add("background_sound", {
    mute: false,
    volume: 0.2,
    rate: 1,
    detune: 0,
  ...
  //set text settings
  machine_text_style = {
    font: game_width * 0.0117 + "px Arial",
    fill: "#2aff00",
    align: "center",
  };
