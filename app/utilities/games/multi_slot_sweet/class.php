...
class multi_slot{
	...
	function __construct($id_player) {
		 ...
		 $this->figures_on_reels[1] = array(
								  ...
								  array("figure"=>"fig6","amount"=>"20"),
								  array("figure"=>"fig7","amount"=>"21"),
								  array("figure"=>"fig8","amount"=>"22"),
								  array("figure"=>"fig9","amount"=>"27"),
								  array("figure"=>"fig10","amount"=>"29"),
								  array("figure"=>"fig11","amount"=>"15"),
								  array("figure"=>"fig12","amount"=>"15"),
								  array("figure"=>"fig13","amount"=>"15")
							 );
	...
	function get_prize($bet_amount, $line_position ,$reels_result){
		...
		if($reels_result[$line[0]-1] == $reels_result[$line[1]-1] && $reels_result[$line[1]-1] == $reels_result[$line[2]-1] && $reels_result[$line[2]-1] == $reels_result[$line[3]-1] && $reels_result[$line[3]-1] == $reels_result[$line[4]-1]){			
			...
			switch($reels_result[$line[0]-1]){ 
				case "fig1": $win = $bet_amount * 10000;  break; 
				case "fig2": $win = $bet_amount * 1500;  break;
				case "fig3": $win = $bet_amount * 1000;  break;
				case "fig4": $win = $bet_amount * 800;  break;
				case "fig5": $win = $bet_amount * 600;  break;
				case "fig6": $win = $bet_amount * 450;  break;
				case "fig7": $win = $bet_amount * 300;  break;
				case "fig8": $win = $bet_amount * 200;  break;
				case "fig9": $win = $bet_amount * 150;  break;
				case "fig10": $win = $bet_amount * 100;  break;
				case "fig11": $win = $bet_amount * 50; $fsp = 10; break;
				case "fig12": $win = $bet_amount * 25; $fsp = 5; break;
				case "fig13": $win = $bet_amount * 15; $fsp = 3;  break; 
			}
			...
			//X4
			switch($reels_result[$line[0]-1]){ 
				case "fig1": $win = $bet_amount * 2000;  break;
				case "fig2": $win = $bet_amount * 800;  break;
				case "fig3": $win = $bet_amount * 550;  break;
				case "fig4": $win = $bet_amount * 400;  break;
				case "fig5": $win = $bet_amount * 300;  break;
				case "fig6": $win = $bet_amount * 250;  break;
				case "fig7": $win = $bet_amount * 200;  break;
				case "fig8": $win = $bet_amount * 150;  break;
				case "fig9": $win = $bet_amount * 100;  break;
				case "fig10": $win = $bet_amount * 50;  break;
				case "fig11": $win = $bet_amount * 25; $fsp = 3; break;
				case "fig12": $win = $bet_amount * 10; $fsp = 2;  break;
				case "fig13": $win = $bet_amount * 5; $fsp = 1;  break;
			}
			...
			//X3 ...
			switch($reels_result[$line[0]-1]){ 
				case "fig1": $win = $bet_amount * 1000;  break;
				case "fig2": $win = $bet_amount * 650;  break;
				case "fig3": $win = $bet_amount * 400;  break;
				case "fig4": $win = $bet_amount * 300;  break;
				case "fig5": $win = $bet_amount * 200;  break;
				case "fig6": $win = $bet_amount * 150;  break;
				case "fig7": $win = $bet_amount * 100;  break;
				case "fig8": $win = $bet_amount * 50;  break;
				case "fig9": $win = $bet_amount * 25;  break; 
				case "fig10": $win = $bet_amount * 15;  break;
				case "fig11": $win = $bet_amount * 10; $fsp = 1; break;
				case "fig12": $win = $bet_amount * 5; $fsp = 0; break;
				case "fig13": $win = $bet_amount * 3; $fsp = 0;   break;
			}
	...
	function set_reels_content($fixed = true){
		...
		if($fixed){
			...
			$json = file_get_contents($_SERVER['DOCUMENT_ROOT']."/utilities/games/multi_slot_sweet/json/pf.txt");		
