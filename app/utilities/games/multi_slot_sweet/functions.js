//Set game vars
var core_url = '/utilities/games/multi_slot_sweet/action.php?gid='+gid+'&';
...
function update (){
	...
	for(var i = 0; i < vibrating_figures.length; i++){ 
		if(vibrating_figures_direction[vibrating_figures[i]] == "le"){
			figures[vibrating_figures[i]].angle -= 2;
		}else{
			figures[vibrating_figures[i]].angle += 2;
		}
		
		if(figures[vibrating_figures[i]].angle  < -20){
			vibrating_figures_direction[vibrating_figures[i]] = "ri";
		}else if(figures[vibrating_figures[i]].angle > 20){
			vibrating_figures_direction[vibrating_figures[i]] = "le";
		}
	}
